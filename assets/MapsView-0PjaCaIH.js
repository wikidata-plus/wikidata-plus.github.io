import{W as c,a as u,V as b,_ as g,b as h,u as v}from"./color-BUAkOZH_.js";import{d as f,r as A,c as C,D as P,E as l,F as O,j as o,f as x,o as r,G as E,H as T,e as S}from"./vuetify-Bz3L5cxd.js";import"./leaflet-B44856_d.js";import"./index-DS4N1NxX.js";const N={class:"map-container"},I=`
...
GROUP BY ?id ?title ?namesake ?namesake_label ?namesake_desc ?namesake_wiki_name ?namesake_wiki_link
  ?taxon_name ?ipni ?bul_label ?osm ?namesake_wikitext`,M=f({__name:"MapsView",setup(L){const k=c({instance:"https://www.wikidata.org",sparqlEndpoint:"https://query.wikidata.org/sparql"}),{stringToHexColor:m}=v();function d(t){var e;const a=(e=s.value)==null?void 0:e.results.bindings.find(n=>{var i;return((i=n.osmRelationId)==null?void 0:i.value)==t});return a!=null&&a.id.value?m(a==null?void 0:a.id.value):"#000000"}const _=k.sparqlQuery(I),s=A(),w=C(()=>{var t;return((t=s.value)==null?void 0:t.results.bindings.map(a=>{var e;return(e=a.osmRelationId)==null?void 0:e.value}))||[]});function p(t){var e;const a=(((e=s.value)==null?void 0:e.results.bindings)||[]).find(n=>{var i;return((i=n.osmRelationId)==null?void 0:i.value)==t});return`
    <div align="center">
    ...
    </div>`}return P(async()=>{try{const t=await u.get(_);s.value=t.data}catch(t){console.error("Error fetching data:",t)}}),(t,a)=>(r(),l("div",N,[a[0]||(a[0]=O("h1",{class:"text-h4 bg-white pa-3"},"Улици в София с име на растение",-1)),o(b,{center:[42.698334,23.319941]},{default:x(()=>[o(g),(r(!0),l(E,null,T(w.value,e=>(r(),S(h,{key:e,id:e,stroke:d(e),"stroke-width":5,"popup-content":p(e)},null,8,["id","stroke","popup-content"]))),128))]),_:1})]))}});export{M as default};
